...
///
/// In server mode, the `@client` annotation marks the hydration boundary.
/// The server pre-renders the component tree below this point on every
/// request, then the browser takes over after JavaScript loads.
@client
